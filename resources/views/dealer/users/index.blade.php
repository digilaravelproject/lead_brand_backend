...
<div id="user-form-modal" class="dealer-modal hidden">
    ...
    <div class="dealer-modal-card">
        ...
        <form id="user-form" action="{{ route('dealer.users.store') }}" method="POST" class="dealer-form-grid">@csrf
