    ...
    <tr><td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 18px 50px rgba(13,148,136,.13);">
            ...
            <tr><td style="padding:34px 40px;">
                ...
                <p style="margin:26px 0 16px;font-size:14px;line-height:1.7;color:#475569;">Your account was created by <strong style="color:#0f766e;">{{ $dealer->name }}</strong>. Sign in using <strong>{{ $user->email }}</strong> and the email OTP sent during login.</p>
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:14px;background:#f8fafc;overflow:hidden;">
                    ...
                    <tr><td style="padding:14px 17px;font-size:12px;font-weight:700;color:#64748b;text-transform:uppercase;">Dealer referral</td><td style="padding:14px 17px;font-family:monospace;font-size:15px;font-weight:800;letter-spacing:2px;color:#0f766e;">{{ $dealer->referral_code }}</td></tr>
                </table>
                <div style="margin-top:24px;padding:16px 18px;border-radius:12px;background:#eff6ff;color:#1e40af;font-size:13px;line-height:1.65;"><strong>What happens after four days?</strong><br>Your dealer can approve continued access. You will be unable to use protected features while approval is pending.</div>
            </td></tr>
