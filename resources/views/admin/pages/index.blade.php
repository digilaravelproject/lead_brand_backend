            ...
            <div class="p-6 space-y-4 overflow-y-auto flex-1 scrollbar">
                ...
                <div>
                    ...
                    <textarea name="description" id="add-description" rows="8" required placeholder="<h2>Privacy Policy</h2><p>Our guidelines details here...</p>"
                              class="w-full bg-slate-950/60 border border-slate-800 rounded-xl py-2.5 px-4 text-white placeholder-slate-655 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500 transition-all text-sm font-mono"></textarea>
                </div>
    ...
    <div class="relative w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl z-10 animate-fade-in max-h-[90vh] flex flex-col">
        <div class="px-6 py-5 border-b border-slate-800 flex items-center justify-between flex-shrink-0">
            <div>
                ...
                <span class="text-xs text-amber-400 font-mono" id="view-type">type: loading</span>
            </div>
            ...
            <div class="p-6 space-y-4 overflow-y-auto flex-1 scrollbar">
                ...
                <div>
                    ...
                    <textarea name="description" id="edit-description" rows="8" required
                              class="w-full bg-slate-950/60 border border-slate-800 rounded-xl py-2.5 px-4 text-white focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500 transition-all text-sm font-mono"></textarea>
                </div>
